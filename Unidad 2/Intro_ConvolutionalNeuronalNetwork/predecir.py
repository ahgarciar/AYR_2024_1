...
alto, largo = 500, 500
modelo = "../Intro_ConvolutionalNeuronalNetwork/modelo/modelo.h5" #./modelo/modelo.h5'
pesos = '../Intro_ConvolutionalNeuronalNetwork/modelo/modelo.h5'
...
def probar_red_neuronal():
    base_location = "../Intro_ConvolutionalNeuronalNetwork/F3-Prueba " #'./F3-Prueba/'
